...
gMemoryDescriptor[] = {
  // 名称, 地址, 长度, Hob选项, 资源类型, 资源属性, 内存类型, ARM属性
  ...
  {"PIL_Reserved",      0x8BC00000, 0x17580000, AddMem, MEM_RES, UNCACHEABLE, Reserv, UNCACHED_UNBUFFERED_XN},
  {"RAM Partition",     0xA3180000, 0x02F80000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv, WRITE_BACK_XN},
  ...
  {"RAM Partition",     0xD3A00000, 0x01700000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv, WRITE_BACK_XN},
  {"Display_Reserved",  0xD5100000, 0x02B00000, AddMem, MEM_RES, SYS_MEM_CAP, Reserv, WRITE_THROUGH_XN},
  {"RAM Partition",     0xD7C00000, 0x00C00000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv, WRITE_BACK_XN},
